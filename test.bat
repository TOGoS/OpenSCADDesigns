...
"%UNIX_FIND_EXE%" 2023/test -name "*.scad" -and -not -path "./2023/lib/*" "(" -exec "C:\Program Files\OpenSCAD\openscad.com" --hardwarnings -o test-output.stl "{}" ";" -o "(" -printf "ERROR EVALUATING %%p" -quit ")" ")"
