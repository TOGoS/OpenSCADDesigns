...
*/
the_holes = ["union",
	for( xm=[-length_chunks/2+0.5 : 0.5 : length_chunks/2-0.5] ) ["translate", [xm*chunk_length, 0, 0], bushing_hole],
	//for( xm=[-length_chunks/2+0.5 : 1 : length_chunks/2] ) ["translate", [xm*chunk_length, 0, height/2], alt_hole],
	for( xm=[-length_chunks/2+0.5 : 0.5 : length_chunks/2-0.5] ) ["translate", [xm*chunk_length, 0, height/2], gridbeam_hole],
	// TODO: THL-1001s in the flange
];
