...
module togridpile_hollow_cup_with_lip(size, lip_height, wall_thickness=2, floor_thickness=2, small_holes=false, large_holes=false) {
	difference() {
		...
		// Interior cavity
		translate([0,0,height+floor_thickness]) togridpile_hull_of_style(cavity_style, [size[0]-wall_thickness*2, size[1]-wall_thickness*2, height*2], corner_radius_offset=-wall_thickness, offset=-margin/2);
...
module togridpile_hollow_cube(size, wall_thickness=2) {
	difference() {
		translate([0,0,size[2]/2]) togridpile_hull(size, offset=-margin/2);
		translate([0,0,size[2]/2]) togridpile_hull_of_style(cavity_style, size, offset=-margin/2-wall_thickness);
