...
// v0.3:
// - Option for less clip overhang, so maybe easier to pull off

rail_width_u = 12;
length_u = 24;
height_u = 16;
inner_corner_extension_u = 0.3;
clip_overhang_u = 2; // [0.5:0.1:3.5]
$fn = 32;
...
function generate_clurp2507_rath(rail_width, clip_height, inner_corner_extension=0.3, overhang=2) =
	let(x0 = rail_width/2)
	let(y1 = clip_height)
...
togmod1_domodule(togmod1_linear_extrude_z([0,length_u*254/160], ["scale", 254/160, togpath1_rath_to_polygon(
	generate_clurp2507_rath(
		rail_width_u, height_u,
