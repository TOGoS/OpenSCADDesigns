...
function generate_clurp2507_rath(rail_width, clip_height, inner_corner_extension=0.3) =
	...
	let(rath_data = [
		["togpath1-rathnode", [ 2, y1-2], ["round", 2]],
		["togpath1-rathnode", [ 4, y1-4], ["round", 2]],
		["togpath1-rathnode", [ 4,    8], ["round", 3]],
		["togpath1-rathnode", [ 0,    4], ["round", 0.8]],
		if(ce > 0) ["togpath1-rathnode", [ 2,    4], ["round", 0.8]],
		["togpath1-rathnode", [ 4+ce, 4+ce], /*if(ce > 0) ["round", ce/2]*/],
		["togpath1-rathnode", [ 0,    0], ["round", 1.5]],
		["togpath1-rathnode", [ 6,    0], ["round", 1.5]],
		["togpath1-rathnode", [ 6, y1-3], ["round", 3]],
		["togpath1-rathnode", [ 3, y1-0], ["round", 3]],
	])
