...
const builder = new Builder({
	rules: {
		...
		...multiOsdBuildRules("2023/gridbeam/Gridrail2.scad", [
			"p1957","p1958","p2244","p2245","p2247",
			"p2437","p2438",
		], {
			cameraPosition: [-20,-20, 20],
			imageSize: [512,512],
		...
		...multiOsdBuildRules("2023/phone-holder/BrickHolder2.scad", [
			"p2067","p2076","p2077","p2323","p2331","p2338","p2379",
			"p2507",
		], {
			cameraPosition: [-15,-20, 20],
			imageSize: [384,384],
		...
		...multiOsdBuildRules("2023/conduit/Clarp2508.scad", [
			"p2006","p2007","p2008","p2009","p2013","p2017","p2018",
			"p2427",
		], {
		...
		...multiOsdBuildRules("2023/misc/BarCap0.scad", [
			"p2147","p2249","p2250","p2329","p2330",
		], {
			cameraPosition: [10,-20,20],
			imageSize: [256,256],
		}),
		...
		...multiOsdBuildRules("2023/track/MiniRail2.scad", [
			"p2184","p2185","p2186","p2187","p2188","p2243","p2327",
			"p2462",
		], {
		...
		...multiOsdBuildRules("2023/experimental/NotebookDisc0.scad", ["p2339","p2380","p2381","p2382"], {
			cameraPosition: [ 20, -40, 40],
			imageSize: [384,384],
			paletteSize: 128,
		}),
		...multiOsdBuildRules("2023/experimental/Hinge1.scad", ["p2386","p2387","p2388","p2401"], {
			cameraPosition: [ 20, -40, 20],
			imageSize: [384,384],
			paletteSize: 128,
		}),
		...multiOsdBuildRules("2023/panel/ReolinkBaseplate0.scad", ["p2394"], {
			openScadCmd: OPENSCAD2024_MANIFOLD_CMD,
			cameraPositions: {
				top   : [-40,-30, 30],
				bottom: [-40,-30,-30],
		...
		...multiOsdBuildRules("2023/clip/FCSubClip0.scad", ["p2395","p2396","p2397","p2398","p2399"], {
			cameraPosition: [-40,-40,40],
			imageSize: [512,512],
			paletteSize: 128,
		}),
		...
		...multiOsdBuildRules("2023/gridbeam/ThreadedGridbeamFoot2.scad", [
			"p2414", "p2420",
		], {
			openScadCmd: OPENSCAD2024_MANIFOLD_CMD,
			cameraPosition: [-30,-40, 30],
		...
		...multiOsdBuildRules("2023/gridbeam/HollowBeam0.scad", [
			"p2433",
			"p2441","p2442","p2443",
			"p2444","p2445","p2446","p2447","p2448","p2449","p2476"
		], {
			cameraPosition: [ 20,-40, 40],
			imageSize: [256, 256],
			paletteSize: 63,
		...
		...multiOsdBuildRules("2023/routing-template/GridbeamPanelRouterTemplate.scad", [
			"p2473", "p2500", "p2557", "p2558", "p2559", "p2560", "p2561", "p2562",
			"p2563", "p2564", "p2566",
		], {
			openScadCmd: OPENSCAD202101_CMD,
		...
		...multiOsdBuildRules("2023/gridbeam/Gridbeam2.scad", [
			"p2477",
		], {
